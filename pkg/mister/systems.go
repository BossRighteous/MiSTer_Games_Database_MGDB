...
// https://github.com/wizzomafizzo/mrext/blob/main/pkg/games/systems.go
// sourced 2024-12-04 for convenience
// Really only using for system ID matching at the moment
